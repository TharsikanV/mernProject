...
exports.forgotPassword=catchAsyncError(async (req,res,next)=>{
    ...
    user.save({validateBeforeSave:false})//save pannum pothu entha validation error um varakoodathu enrathukku

    //Create reset url
    const resetUrl=`${req.protocol}://${req.get('host')}/api/v1/password/reset/${}`
    //http//
