        ...
        <HelmetProvider>
          ...
          <div className="container container-fluid">
            ...
            <Routes>
              ...
              <Route path='/payment' element={<ProtectedRoute><Elements stripe={loadStripe()}><Payment/></Elements></ProtectedRoute>} />{/**strpe elements ellaam Payment component kku kidaikkum */}
            </Routes>
          </div>
          <Footer />
        </HelmetProvider>
