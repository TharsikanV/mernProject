...
import { productRequest, productFail, productSuccess, createReviewRequest, createReviewSuccess, createReviewFail, newProductRequest, newProductSuccess, newProductFail, deleteProductRequest, deleteProductSuccess, deleteProductFail, updateProductRequest, updateProductSuccess, updateProductFail, reviewsRequest, reviewsSuccess, reviewsFail, deleteReviewRequest, deleteReviewSuccess } from '../slices/productSlice';
...
export const getReviews=id=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.get(`/admin/reviews`,{params:{id}});// or id:id
...
export const deleteReview=(productId,id)=>async(dispatch)=>{
    try{
        dispatch(deleteReviewRequest())//action creater ah ull koduthiddam
    
        await axios.get(`/admin/review`,{params:{productId,id}});// or id:id
        dispatch(deleteReviewSuccess())
    }catch(error){
        //handle error
        dispatch(deleteRe(error.response.data.message))
    }
