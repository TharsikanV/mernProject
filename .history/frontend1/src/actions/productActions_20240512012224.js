...
import { productRequest, productFail, productSuccess, createReviewRequest, createReviewSuccess, createReviewFail, newProductRequest, newProductSuccess, newProductFail, deleteProductRequest, deleteProductSuccess, deleteProductFail, updateProductRequest, updateProductSuccess } from '../slices/productSlice';
...
export const updateProduct=(id,productData)=>async(dispatch)=>{
    try{
        ...
        //handle error
        dispatch(upd(error.response.data.message))
    }
