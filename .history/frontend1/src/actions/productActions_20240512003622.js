...
import { productRequest, productFail, productSuccess, createReviewRequest, createReviewSuccess, createReviewFail, newProductRequest, newProductSuccess, newProductFail, deleteProductRequest, deleteProductSuccess } from '../slices/productSlice';
...
export const deleteProduct=id=>async(dispatch)=>{
    try{
        ...
        //handle error
        dispatch(delet(error.response.data.message))
    }
