...
import { productRequest, productFail, productSuccess, createReviewRequest, createReviewSuccess, createReviewFail, newProductRequest, newProductSuccess } from '../slices/productSlice';
...
export const createNewProduct=productData=>async(dispatch)=>{
    try{
        ...
        //handle error
        dispatch(ne(error.response.data.message))
    }
