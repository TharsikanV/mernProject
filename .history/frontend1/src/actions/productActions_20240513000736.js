...
import { productRequest, productFail, productSuccess, createReviewRequest, createReviewSuccess, createReviewFail, newProductRequest, newProductSuccess, newProductFail, deleteProductRequest, deleteProductSuccess, deleteProductFail, updateProductRequest, updateProductSuccess, updateProductFail, reviewsRequest, reviewsSuccess } from '../slices/productSlice';
...
export const getReviews=id=>async(dispatch)=>{
    try{
        ...
        //handle error
        dispatch(rev(error.response.data.message))
    }
