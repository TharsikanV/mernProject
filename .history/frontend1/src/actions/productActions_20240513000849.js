...
import { productRequest, productFail, productSuccess, createReviewRequest, createReviewSuccess, createReviewFail, newProductRequest, newProductSuccess, newProductFail, deleteProductRequest, deleteProductSuccess, deleteProductFail, updateProductRequest, updateProductSuccess, updateProductFail, reviewsRequest, reviewsSuccess, reviewsFail } from '../slices/productSlice';
...
export const deleteReview=(productId,id)=>async(dispatch)=>{
    try{
        dispatch(deleteRe)//action creater ah ull koduthiddam
