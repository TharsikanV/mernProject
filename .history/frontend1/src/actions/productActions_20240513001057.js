...
import { productRequest, productFail, productSuccess, createReviewRequest, createReviewSuccess, createReviewFail, newProductRequest, newProductSuccess, newProductFail, deleteProductRequest, deleteProductSuccess, deleteProductFail, updateProductRequest, updateProductSuccess, updateProductFail, reviewsRequest, reviewsSuccess, reviewsFail, deleteReviewRequest, deleteReviewSuccess, deleteReviewFail } from '../slices/productSlice';
...
export const getReviews=id=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.get(`api/v1/admin/reviews`,{params:{id}});// or id:id
...
export const deleteReview=(productId,id)=>async(dispatch)=>{
    try{
        ...
        await axios.delete(`/api/v1/admin/review`,{params:{productId,id}});// or id:id
