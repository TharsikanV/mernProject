...
import { productsRequest, productsFail, productsSuccess, adminProductsRequest, adminProductsSuccess } from '../slices/productsSlice';
...
export const getAdminProducts=async(dispatch)=>{
    try{
        ...
        //handle error
        dispatch(ad(error.response.data.message))
    }
