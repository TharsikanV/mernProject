...
import { productRequest, productFail, productSuccess, createReviewRequest, createReviewSuccess } from '../slices/productSlice';
...
export const createReview=reviewData=>async(dispatch)=>{//id parameter ah vaankiram
    try{
        ...
        //handle error
        dispatch(createR(error.response.data.message))
    }
