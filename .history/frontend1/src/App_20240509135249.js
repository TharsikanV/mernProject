        ...
        <HelmetProvider>
          ...
          <div className="container container-fluid">
            ...
            <Routes>
              ...
              {stripeApiKey &&}
              <Route path='/payment' element={<ProtectedRoute><Elements stripe={loadStripe(stripeApiKey)}><Payment/></Elements></ProtectedRoute>} />{/**strpe elements ellaam Payment component kku kidaikkum */}
            </Routes>
          </div>
          <Footer />
        </HelmetProvider>
