...
export default function Search() {
    ...
    useEffect(()=>{//oru component load aaki mudincha udana call seyyapdura functione ithuthaan
        if(location.pathname==='/'){
            clearKeyword();
        }
    },[location])//dependecy ah location ah kodukkanum eanna athu maarakoodiyathu
