...
export default function ProductSearch() {
    ...
    }, [error, dispatch, currentPage, keyword, priceChanged,category,ra])//price kku pathila priceChanged ah koduthaa adikkadi slider maara maara load aakirathu thadukkapadum
    return (
        <Fragment>
            {loading ? <Loader /> :
                <Fragment>
