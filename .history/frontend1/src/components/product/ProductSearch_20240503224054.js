...
export default function ProductSearch() {
    ...
    useEffect(() => {
        ...
        dispatch(getProducts(keyword, price,ca currentPage))
    }, [error, dispatch, currentPage, keyword, priceChanged,category])//price kku pathila priceChanged ah koduthaa adikkadi slider maara maara load aakirathu thadukkapadum
    return (
        <Fragment>
            {loading ? <Loader /> :
                <Fragment>
