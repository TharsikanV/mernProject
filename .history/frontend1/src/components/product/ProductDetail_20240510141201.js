...
export default function ProductDetail() {
    ...
    }, [dispatch, id])//component load aaki mudichathum orukka load aakum
                                ...
                                <div className="rating w-50">
                                    <Modal show={show} onHide={handleClose}>
                                        ...
                                        <Modal.Body>
                                            ...
                                            <button aria-label="Close"  className="btn my-3 float-right review-btn px-4 text-white">Submit</button>
                                        </Modal.Body>
                                    </Modal>
                                </div>
