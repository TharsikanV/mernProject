...
import { getProduct, updateProduct } from "../../actions/orderActionsActions";
import { clearError, clearProductUpdated } from "../../slices/productSlice";
import { toast } from "react-toastify";

export default function UpdateOrder() {
    // const { id: productId } = useParams();//id ah eduthiddam
    ...
    const submitHandler = (e) => {
        ...
        dispatch(UpdateOrder(productId, formData))
    }
    ...
    useEffect(() => {
        if (isProductUpdated) {
            ...
            setImages([])//ithu ethikinna earkanave update panni iruntha state la irukkum athu previwla ennorukka theriyum atha thadukka state ah empty aakiran 
            return;
        }
