...
export default function Register() {
    ...
    const onChange=(e)=>{
        if(e.target.name==='avatar'){
            ...
            reader.onload=(e)=>{//eppa url ah irunthu read panni mudichutho intha function call seyya padanum
                if(reader.readyState===2){//read panni mudichitha illaya endratha therivikkira field ah irukkum
