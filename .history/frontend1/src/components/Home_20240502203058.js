...
export default function Home() {
    ...
    const { products, loading,error,productsCount} = useSelector((state) => state.productsState)//statela irunthu products data ah eduthiddam
                ...
                <Fragment>
                    ...
                    <div className="d-flex justify-content-center mt-5">
                            <Pagination
                                ...
                                totalItemsCount={productsCount}//moththa products ah kaad
                            />
                    </div>
                </Fragment>
            }
